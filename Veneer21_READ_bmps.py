...
runfile('C:/Users/h17163/RauteDT/FCN_DefectsAnalysis.py', wdir='C:/Users/h17163/RauteDT')
runfile('C:/Users/h17163/RauteDT/OBJ_PicGLCM.py', wdir='C:/Users/h17163/RauteDT')
...
pfolder = 'C:/Users/h17163/RauteDT/kutistuma/veneer21_wet/'
dfolder = 'C:/Users/h17163/RauteDT/kutistuma/veneer21_dry/'

# ...Small Size Images Saving Folder (destination)
pPicDest = 'C:/Users/h17163/RauteDT/kutistuma/veneer21_wetSmall/'
dPicDest = 'C:/Users/h17163/RauteDT/kutistuma/veneer21_drySmall/'

# ...GLCM Feature arrays (destination)
pGLCMDest = 'C:/Users/h17163/RauteDT/kutistuma/veneer21_wetGLCM/'
dGLCMDest = 'C:/Users/h17163/RauteDT/kutistuma/veneer21_dryGLCM/'
...
for k in range(len(test)):
    ...
    pd.to_pickle(matchData, 
                 'MatchingPaperRESULTSFullDataOptimizedGrids_P1@all_P2@all/RandMatchData'
    ...
    for k in range(len(combs)):
        ...
        savename = 'grids_'+str(nGrids)+'_sensitivity_'+\
            str(combs[k]).replace(', ','_').replace(')','').replace('(','')+\
                '.pkl'
        pd.to_pickle(matchData, 'MatchingPaperRESULTSCleanSA_sample100_rounds100/'+savename)
